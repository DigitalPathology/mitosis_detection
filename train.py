...
for epoch in range(num_epochs):
    ...
    if phase in validation_phases:
        print(f'{phase}/TN', cmatrix[phase][0, 0], epoch+1)
        print(f'{phase}/TP', cmatrix[phase][1, 1], epoch+1)
        print(f'{phase}/FP', cmatrix[phase][0, 1], epoch+1)
        print(f'{phase}/FN', cmatrix[phase][1, 0], epoch+1)
        print(f'{phase}/TNR', cmatrix[phase][0, 0] / (cmatrix[phase][0, 0] + cmatrix[phase][0, 1]), epoch+1)
        print(f'{phase}/TPR', cmatrix[phase][1, 1] / (cmatrix[phase][1, 1] + cmatrix[phase][1, 0]), epoch+1)
